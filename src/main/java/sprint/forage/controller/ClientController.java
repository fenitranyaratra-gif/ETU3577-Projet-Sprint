...
public class ClientController {
    ...
    public ModelAndView listeClients() {
        ...
        modelAndView.addObject("titre", "Liste Clients");
        modelAndView.addObject("sousTitre", "Gestion an i clients");
    ...
    public ModelAndView showAddForm() {
        ...
        modelAndView.addObject("titre", "Ajout Client");
        return modelAndView;
    }
    ...
    public ModelAndView addClient(@ModelAttribute Client client,
        ...
        if (client.getContact() == null ) {
            ...
            modelAndView.addObject("errorMessage", "Le contact vide");
            return modelAndView;
        }
        ...
        if (client.getNom() == null ) {
            ...
            modelAndView.addObject("client", client);
            modelAndView.addObject("titre", "Ajouter un Client");
            modelAndView.addObject("errorMessage", "Le nom vide");
            return modelAndView;
        }
        
        try {
            clientService.createClient(client);
            redirectAttributes.addFlashAttribute("successMessage", "Client mety!");
        } catch (Exception e) {
    ...
    public ModelAndView updateClient(@PathVariable Long id,
        ...
        if (client.getNom() == null || client.getNom().trim().isEmpty()) {
            ...
            modelAndView.addObject("titre", "Modifier");
            modelAndView.addObject("errorMessage", "Le nom vide");
            return modelAndView;
        }
    ...
    public ModelAndView deleteClient(@PathVariable Long id,
        ...
        if (client == null) {
            ...
            try {
                ...
                redirectAttributes.addFlashAttribute("successMessage", "Client supprim mety");
            } catch (Exception e) {
