...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1>${titre}</h1>
            <a href="${pageContext.request.contextPath}/candidats/ajouter" class="btn btn-success">
                ...
                <tbody>
                    ...
                    %>
                        <tr>
                            ...
                            <td><%= c.getPrenom() %></td>
                            <td>
                                <a href="${pageContext.request.contextPath}/candidats/modifier/<%= c.getId() %>" class="btn btn-sm btn-warning">
