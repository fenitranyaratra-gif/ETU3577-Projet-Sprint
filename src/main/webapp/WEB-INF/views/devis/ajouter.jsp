...
<%@ page import="java.util.List, sprint.forage.entity.Demande, sprint.forage.entity.TypeDevis" %>
<%
        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-sm" style="border-radius: 15px;">
                <div class="card-body p-4">
                    <form action="/devis/ajouter" method="post">
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="demandeId" name="demandeId" required>
                                ...
                                <% for(Demande demande : demandes) { %>
                                    <option value="<%= demande.getIdDemande() %>">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="typeDevisId" name="typeDevisId" required>
                                ...
                                <% for(TypeDevis type : typesDevis) { %>
                                    <option value="<%= type.getIdTypeDevis() %>"><%= type.getLibelle() %></option>
                                <% } %>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="<%= new java.text.SimpleDateFormat("dd/MM/yyyy").format(new java.util.Date()) %>" disabled>
                            <small class="text-muted">La date sera automatiquement enregistrée</small>
                        </div>
